          ...
          >
            ...
            <div>
              <div className="flex flex-col gap-3 items-center lg:items-start">
                <Logo />
                <p className={`font-bold text-2xl ${unbounded.className} text-center lg:text-left`}>
            ...
            {footerSections.map(({ title, links }) => (
              ...
              >
                <p className={`font-semibold text-lg ${unbounded.className}`}>{title}</p>
            ...
            >
              <p className={`font-semibold text-center lg:text-left ${figtree.className}`}>Newsletter</p>
              <form
              ...
              <span className={`text-xs text-gray-500 mt-1 text-center lg:text-left ${figtree.className}`}>
