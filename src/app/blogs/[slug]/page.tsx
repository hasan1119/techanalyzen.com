...
export default function BlogSinglePage() {
  ...
  return (
    <div className='container py-16 lg:px-0 mx-auto px-4 sm:px-6'>
      <section className='flex flex-row mb-16'>
        <div className='flex flex-col items-center mr-6 w-full flex-1 min-w-[300px]'>
        ...
        <article className='bg-card rounded-xl shadow-lg border p-6 sm:p-8 mb-16 max-w-4xl'>
          ...
          <div className='prose prose-lg max-w-none text-foreground'>
            <p>
              At RX Group of Corporation, we believe that innovation is the key
              to a brighter future. Our journey has been marked by a relentless
            ...
            <p>
              ...
              transformation to healthcare and wellness, our team is dedicated
              to staying ahead of the curve and delivering solutions that
              matter.
            </p>
            <h2 className='text-2xl sm:text-3xl font-semibold mt-8 mb-4'>
              Our Mission
      ...
      <AdUnit slotId='5262155604' type='in-feed' />
