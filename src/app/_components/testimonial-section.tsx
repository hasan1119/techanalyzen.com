              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="flex items-center mb-4">
                    ...
                    />
                    <div>
                      <h4 className={`font-semibold text-gray-900 dark:text-white ${unbounded.className}`}>{testimonial.name}</h4>
                      <p className={`text-sm text-gray-600 dark:text-gray-400 ${figtree.className}`}>{testimonial.title}</p>
                    </div>
                  </div>
                  <p className={`text-base text-gray-700 dark:text-gray-200 leading-relaxed ${figtree.className}`}>
                    {testimonial.text}
                  </p>
                </div>
              ))}
