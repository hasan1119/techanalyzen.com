    ...
    <section id="contact" className="gradient-primary border-t">
      <Container>
        <div className="w-full py-18 px-4 md:px-8 lg:px-0 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20">
          ...
          >
            <SectionTitle className="text-start">Get in touch</SectionTitle>
            <div className="flex flex-col gap-y-10 pt-10">
              <div className="flex lg:items-center gap-4 sm:gap-6 md:gap-8">
                ...
                <div className="border-b border-black pb-1">
                  <h4
                    className={`text-xs text-start sm:text-base md:text-lg text-text-600 leading-[22px] mb-2 sm:mb-3.5 md:mb-2 ${unbounded.className}`}
                  >
                    Whatsapp Link
                  </h4>
                  <a
                    href="https://api.whatsapp.com/send?phone=8801743591672"
                    className={`text-sm sm:text-lg md:text-xl text-text-900 leading-[22px] font-semibold break-all ${figtree.className}`}
                    target="_blank"
                  >
                    https://wa.me/message/dsfrewr5345
                  </a>
                </div>
              </div>
              ...
              <div className="flex lg:items-center gap-4 sm:gap-6 md:gap-8">
                <div className="w-12 sm:w-16 md:w-[4.5rem] h-12 sm:h-16 md:h-[4.5rem] rounded-full bg-gradient-to-r from-green-500 via-emerald-600 to-teal-600 backdrop-blur-3xl flex items-center justify-center">
                  <svg
                    ...
                    viewBox="0 0 32 32"
                    fill="none"
                    className="w-6 text-white h-6 sm:w-8 sm:h-8"
                  >
                    <path
                ...
                <div className="">
                  <h4
                    className={`text-xs sm:text-base md:text-lg text-text-600 leading-[22px] mb-2 sm:mb-3.5 md:mb-2 text-start ${unbounded.className}`}
                  >
                    Email Us
                  </h4>
                  <a
                    href="mailto:hello@netrosystems.com"
                    className={`text-sm sm:text-lg md:text-xl text-text-900 leading-[22px] font-semibold break-all ${figtree.className}`}
                    target="_blank"
                  >
              ...
              <div className="flex lg:items-center gap-4 sm:gap-6 md:gap-8">
                ...
                <div className="text-start">
                  ...
                  <p
                    className={`text-sm sm:text-lg md:text-xl text-text-900 leading-[22px] font-semibold break-all mt-2 ${figtree.className}`}
                  >
