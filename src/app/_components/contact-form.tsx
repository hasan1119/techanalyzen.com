    ...
    <div className='bg-[#39b6501a] border border-dashed border-natural-400 shadow py-10 px-8 rounded-2xl mx-2 md:mx-0'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-y-5 md:gap-x-4 md:gap-y-6'>
        ...
        <div className='flex flex-col'>
          <label htmlFor='fname' className={`mb-1 font-medium dark:text-[#f6f3fc] text-gray-800 ${figtree.className}`}>
            First Name
          </label>
          <input
        ...
        {/* Last name */}
        <div className='flex flex-col'>
          <label htmlFor='lname' className={`mb-1 font-medium dark:text-[#f6f3fc] text-gray-800 ${figtree.className}`}>
            Last Name
          </label>
          <input
            className='border border-dashed border-[#22272c]/30 dark:border-[#22272c] rounded-lg py-3 px-4 text-base outline-none bg-transparent transition-all ease-in-out focus:border-primary dark:focus:border-primary dark:text-[#f6f3fc] text-gray-700 w-full'
        ...
        {/* Phone */}
        <div className='flex flex-col'>
          <label htmlFor='phone' className={`mb-1 font-medium dark:text-[#f6f3fc] text-gray-800 ${figtree.className}`}>
            Phone
          </label>
          <input
            className='border border-dashed border-[#22272c]/30 dark:border-[#22272c] rounded-lg py-3 px-4 text-base outline-none bg-transparent transition-all ease-in-out focus:border-primary dark:focus:border-primary dark:text-[#f6f3fc] text-gray-700 w-full'
        ...
        {/* Email */}
        <div className='flex flex-col'>
          <label htmlFor='email' className={`mb-1 font-medium dark:text-[#f6f3fc] text-gray-800 ${figtree.className}`}>
            Email
          </label>
          <input
            className='border border-dashed border-[#22272c]/30 dark:border-[#22272c] rounded-lg py-3 px-4 text-base outline-none bg-transparent transition-all ease-in-out focus:border-primary dark:focus:border-primary dark:text-[#f6f3fc] text-gray-700 w-full'
        ...
        <div className='flex flex-col md:col-span-2'>
          <label htmlFor='description' className={`mb-1 font-medium dark:text-[#f6f3fc] text-gray-800 ${figtree.className}`}>
            Description
          </label>
          <textarea
