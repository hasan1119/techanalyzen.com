              ...
              >
                <Card className="rounded-2xl shadow-lg bg-gradient-to-b  transition-all duration-300 bg-white dark:bg-zinc-900/50 p-6 backdrop-blur-sm hover:scale-105 hover:shadow-lg">
                  <CardHeader className="flex flex-col items-center p-6">
                    ...
                    <p className={`text-sm font-medium text-gray-600 dark:text-gray-400 ${figtree.className}`}>
                      {member.role}
                    </p>
                  </CardHeader>
                  <CardContent className="flex flex-col items-center gap-3 pb-6">
                    ...
                    >
                      <Link href={member.portfolio} target="_blank" className="flex items-center gap-2">
